"""Bulk-load SRLDC jsonl into Supabase via PostgREST upsert (idempotent)."""
import json
import sys
import time
import requests
...
TABLES = {
    "regional": ("srldc_regional_availability", "report_date"),
    "state_demand": ("srldc_state_demand", "report_date,state_canonical"),
    "state_generation": ("srldc_state_generation", "report_date,state_canonical,seq"),
}
